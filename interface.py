...
button1 = customtkinter.CTkButton(master=frame, width=220, text="Guide", command=button_function, corner_radius=6)
button1.place(x=50, y=240)


button2 = customtkinter.CTkButton(master=frame, width=220, text="Activate Mouse", command=button_function, corner_radius=6)
